...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean checkPermissions() {
        return ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) == android.content.pm.PackageManager.PERMISSION_GRANTED
                && ContextCompat.checkSelfPermission(this, Manifest.permission.READ_PHONE_STATE) == android.content.pm.PackageManager.PERMISSION_GRANTED;
    }
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                    mManager.discoverPeers(mChannel, new WifiP2pManager.ActionListener() {
                        ...
                        public void onSuccess() {
                            ...
                            Toast.makeText(getApplicationContext(), "Veziyyet zor", Toast.LENGTH_SHORT).show();
                        ...
                        public void onFailure(int i) {
                            String errorMessage = "Discovery Failed. Reason: ";
                            switch (i) {
                                case WifiP2pManager.P2P_UNSUPPORTED:
                                    errorMessage += "P2P Unsupported";
                                    break;
                                case WifiP2pManager.BUSY:
                                    errorMessage += "Framework is busy";
                                    break;
...
//                .check();
    ...
    private boolean VerifySign(String tempMsg) {
        ...
        try {
            ...
            if (SigState) {
                message_history.add("SIGNATURE VERIFIED");
            } else {
                message_history.add("SIGNATURE NOT VERIFIED");
            }
